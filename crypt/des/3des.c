...
void main(void)
{
  ...
  const unsigned char key[16] = {0x00,0x01,0x03,0x04,0x05,0x06,0x08,0x09,0x0a,0x0b,0x0c,0x0e,0x0f,0x1,0x2,0x05};
  const unsigned char data[32] = {0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,
                                                                    0x08,0x09,0x00,0x01,0x02,0x03,0x04,0x05,
                                                                    0x06,0x07,0x08,0x09,0x00,0x01,0x02,0x03,
                                                                    0x04,0x05,0x06,0x07,0x08,0x09,0x00,0x01};

  printf("des test function\n");
  memcpy((void*)plain,data,32);
  des_encrypt(key,8,plain,cipher,4);      
  printf("sc_des cipher data: \n");
  ...
  printf(("\n"));       
  if(des_decrypt(key,8,cipher,plain,4) == 0x0)
  {
  ...
  memcpy((void*)plain,data,32);
  des_encrypt(key,16,plain,cipher,4);
  printf("sc_3des cipher data: \n");
  ...
  if(des_decrypt(key,16,cipher,plain,4) == 0x0)
  {
      printf("sc_3des plain data: \n");
      for(i = 0; i < 32; i++)
       {
           printf("%02x ",plain[i]);
       }
